...
{"type": "function", "function": {"name":"FrameAt","description":"Select and return a single frame from the 64 video frames provided as input to the model.","parameters": {"type":"object","properties":{"target_frame":{"type":"integer","description":"The index of the frame to select, ranging from 1 to 64 (corresponding to the 64 frames fed into the model)."}},"required":["target_frame"]}}}
